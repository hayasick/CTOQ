function [K, h, lambda_chosen, sigma_chosen]=RuLSIF_mod(x_nu,x_de,x_re, alpha,sigma_list,lambda_list,b,fold)
%
...
%
% [31 Aug 2016]
% This code is slightly modified by Kohei Hayashi.
% The original licence is as follow.
% --------------------------------------------  
% (c) Makoto Yamada & Masashi Sugiyama, Department of Compter Science, Tokyo Institute of Technology, Japan.
%     yamada@sg.cs.titech.ac.jp, sugi@cs.titech.ac.jp,
%     http://sugiyama-www.cs.titech.ac.jp/~sugi/software/RuLSIF/
% 
...
K = alpha*K_nu*K_nu'/n_nu + (1-alpha)*K_de*K_de'/n_de;
h = mean(K_nu,2);
